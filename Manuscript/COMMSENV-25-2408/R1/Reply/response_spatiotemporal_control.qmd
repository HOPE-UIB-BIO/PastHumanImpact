...
```{r}
#| fig-cap: >-
#|   Shares of positive hierarchical contribution after adding space as a
#|   separate structural predictor within each 500-year time slice. Negative
#|   fractions were set to zero and each eligible bar was renormalised to sum
#|   to one. SPD is the primary human-activity proxy; event-based bars are
#|   supplementary.
knitr::include_graphics(
  file.path(
    temporal_figure_dir,
