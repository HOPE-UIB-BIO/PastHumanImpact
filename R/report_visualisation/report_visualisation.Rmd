...
## Create a tibble with data to produce figures

It is nested as different figures need different input either based on the summary table output or to create Euler diagrams.  
...
### Select single predictor variable to compare

Display explained individual variation by humans between and within regions and ecozones 
...
Display explained variation between predictor variables between the individual datasets
...
Display explained variation between predictor variables between regions 
...
Get plot for percentage contribution for each climate zone, colored by
...
First produce and save figures for individual records in object data_to_map
...
### Alternative adding barplots on map
