...
data_pap_observed <-
  ...
  dplyr::mutate(
    pap_label = resolve_temporal_variable_label(variable),
    pap_label = factor(
      pap_label,
      levels = resolve_temporal_variable_label(vec_all_paps)
    )
  )
...
assertthat::assert_that(
  ...
  msg = "PAP predictions must cover all PAPs over observed dataset ranges."
)
