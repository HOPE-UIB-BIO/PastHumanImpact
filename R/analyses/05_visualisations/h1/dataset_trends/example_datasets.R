...
#                   GlobalHumanImpact
#
#                Example dataset trends
#            HVarPart dataset temporal examples
#
#                   V. Felde, O. Mottl
#                         2026
#
...
#----------------------------------------------------------#
# 2. Select contrasting complete datasets -----
#----------------------------------------------------------#
...
assertthat::assert_that(
  ...
  msg = "The established HVarPart example datasets require complete inputs."
)
...
assertthat::assert_that(
  setequal(
    unique(data_dataset_predictions[["dataset_id"]]),
    data_selected_examples[["dataset_id"]]
  ),
  msg = "Both selected datasets require current dataset-specific predictions."
)


#----------------------------------------------------------#
# 4. Build HVarPart dataset examples -----
#----------------------------------------------------------#

vec_selected_ids <-
  data_selected_examples[["dataset_id"]]
list_raw_by_dataset <-
  split(data_dataset_raw, data_dataset_raw[["dataset_id"]])
