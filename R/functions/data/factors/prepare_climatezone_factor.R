#' @title Prepare climatezone factor columns
#' @description
...
prepare_climatezone_factor <- function(data_source) {
  ...
  res_data <-
    ...
    dplyr::mutate(
      ...
      climatezone_label = resolve_climatezone_label(as.character(climatezone)),
