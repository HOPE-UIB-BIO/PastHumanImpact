...
#' @param family_key Stable family key used by `resolve_model_family()`.
...
#' @param model_profile Formula profile used by `build_hgam_formula()`.
    ...
    tryCatch(
      {
        brms::brm(
          ...
          data = data_source,
          family = resolve_model_family(family_key = family_key),
