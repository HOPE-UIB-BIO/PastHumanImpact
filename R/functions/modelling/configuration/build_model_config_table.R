#' @title Build a general model configuration table
#' @description
...
#' @examples
#' \dontrun{
#' config <- build_model_config_table(data_model = data_pap_model)
#' }
build_model_config_table <- function(
  data_model,
