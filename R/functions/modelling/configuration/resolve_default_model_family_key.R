#' @title Resolve default family key for temporal model variables
#' @description
...
#' @examples
#' \dontrun{
#' family_key <- resolve_default_model_family_key("n0", "pap_temporal")
#' }
resolve_default_model_family_key <- function(variable, analysis) {
