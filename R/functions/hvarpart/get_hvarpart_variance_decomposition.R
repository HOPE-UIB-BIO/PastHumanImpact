#' @title Get model-level HVarPart variance decompositions
#' @description
...
#' @param data_importance Output from `get_hvarpart_importance()`.
...
get_hvarpart_variance_decomposition <- function(
  data_importance,
  id_cols,
  tolerance = 0.001
) {
