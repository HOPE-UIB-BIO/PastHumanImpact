#' @title Format a dataset temporal figure caption
#' @description Format location, elevation, environment, and data-source notes.
#' @param data_metadata One-row dataset metadata data frame.
#' @return Character scalar figure caption.
#' @examples
#' caption <- build_dataset_temporal_caption(
#'   data.frame(
#'     long = 8.5,
#'     lat = 46.4,
#'     altitude = 1936,
...
#'   )
#' )
build_dataset_temporal_caption <- function(data_metadata) {
