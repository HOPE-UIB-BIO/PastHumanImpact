#' @title Plot temporal trends for one dataset
#' @description
#' Plot raw, interpolated, and dataset-specific fitted trajectories for all
#' available PAP and predictor variables in one pollen dataset, aligned vertically
#' by age.
...
#' )
#' }
plot_dataset_temporal_trends <- function(
  data_raw,
  data_observed,
  data_predictions,
  data_metadata,
  ...
  figure_caption <-
    build_dataset_temporal_caption(data_metadata = data_metadata)
  pap_legend_label <-
