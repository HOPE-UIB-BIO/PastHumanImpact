#' @title Combine HVarPart and temporal results for one dataset
#' @description
...
#' )
#' }
plot_hvarpart_dataset_temporal_example <- function(
  data_raw,
  data_observed,
  data_predictions,
  data_metadata,
  ...
  assertthat::assert_that(
    ...
    msg = "A dataset example must describe one dataset."
  )
