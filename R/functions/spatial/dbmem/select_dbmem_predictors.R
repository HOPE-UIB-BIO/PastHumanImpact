...
select_dbmem_predictors <- function(
  ...
  mat_response <-
    select_nonconstant_matrix_columns(data_matrix = mat_response)
  mat_mem <-
    select_nonconstant_matrix_columns(data_matrix = mat_mem)
  ...
  mat_mem_residual <-
    select_nonconstant_matrix_columns(data_matrix = mat_mem_residual)
  if (
