#' @title Select constant columns from a numeric matrix
#' @description
...
#' @examples
#' \dontrun{
#' select_nonconstant_matrix_columns(data_matrix = matrix(1:6, ncol = 2))
#' }
select_nonconstant_matrix_columns <- function(data_matrix) {
