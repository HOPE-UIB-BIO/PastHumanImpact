#' @title Prepare core-level HVarPart balances for spatial analysis
#' @description
#' Convert paired human and climate HVarPart components into signed and exact
#' zero-truncated core-level balances with the denominators used as weights.
#' @param data_importance Canonical output from `get_hvarpart_importance()`.
