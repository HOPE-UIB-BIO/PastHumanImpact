...
#palette_eco <- c("#88CCEE", "#332288", "#117733", "#DDCC77", "#CC6677", "#44AA99", "#999933") 
#human vs climate
...
```{r human indicator table for LA}
...
```{r summary table for individual records}
...
```{r summary table of the median results}
...
```{r summary table for the temporal analysis}
...
```{r summary table for the median results}
...
summarise_by_all %>%
  flextable::flextable() %>%
  flextable::set_caption("Table 10: Summary of MRT results") %>%
  flextable::autofit()
...
summarise_by_ecozone %>%
  flextable::flextable() %>%
  flextable::set_caption("Table 11: Summary of individual MRT results nested by ecozones") %>%
  flextable::autofit()
