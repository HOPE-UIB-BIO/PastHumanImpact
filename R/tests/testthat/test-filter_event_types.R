testthat::test_that("filter_event_types() builds region-specific events", {
  data_source_meta <-
    data.frame(
      dataset_id = c(1, 2),
...
testthat::test_that("filter_event_types() keeps only allowed columns per region", {
  data_source_meta <-
    data.frame(
      dataset_id = 10,
      region = "Europe",
...
testthat::test_that("filter_event_types() errors for unsupported regions", {
  data_source_meta <-
    data.frame(
      dataset_id = 1,
      region = "Atlantis",
...
testthat::test_that("filter_event_types() validates required inputs", {
  data_source_meta <-
    data.frame(
      dataset_id = 1,
      region = "Asia",
