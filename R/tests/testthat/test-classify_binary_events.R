testthat::test_that("classify_binary_events() returns nested binary event tables", {
...
testthat::test_that("classify_binary_events() validates required input columns", {
...
testthat::test_that("classify_binary_events() validates nested list-column tables", {
  data_source_events <-
    data.frame(
      dataset_id = 1,
      region = "Asia",
...
testthat::test_that("classify_binary_events() validates required pollen columns", {
  data_source_events <-
    data.frame(
      dataset_id = 1,
      region = "Asia",
...
testthat::test_that("classify_binary_events() validates nested events_age columns", {
  data_source_events <-
    data.frame(
      dataset_id = 1,
      region = "Asia",
