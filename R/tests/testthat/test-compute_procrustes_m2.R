testthat::test_that("compute_procrustes_m2() returns lower-triangular matrix with NA upper triangle", {
  ...
  res_mat <-
    compute_procrustes_m2(list_pca)
...
testthat::test_that("compute_procrustes_m2() m2 values are in [0, 1]", {
  testthat::skip_if_not_installed("vegan")
...
testthat::test_that("compute_procrustes_m2() handles two-element list (2x2 matrix)", {
  testthat::skip_if_not_installed("vegan")
...
testthat::test_that("compute_procrustes_m2() validates named non-empty list input", {
  testthat::expect_error(
    compute_procrustes_m2(data_list = list()),
    regexp = "must not be empty"
  )

  testthat::expect_error(
    compute_procrustes_m2(data_list = list(NULL)),
