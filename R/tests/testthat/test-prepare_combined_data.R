testthat::test_that("prepare_combined_data() joins properties and predictors by age", {
...
testthat::test_that("prepare_combined_data() keeps only intersecting dataset_id", {
  data_source_properties <-
    data.frame(
      dataset_id = c(1, 2),
      data_merge = I(list(
...
testthat::test_that("prepare_combined_data() returns merged age intersection", {
  data_source_properties <-
    data.frame(
      dataset_id = 7,
...
testthat::test_that("prepare_combined_data() validates required columns", {
  data_source_properties <-
    data.frame(
      dataset_id = 1,
