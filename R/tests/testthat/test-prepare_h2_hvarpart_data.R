testthat::test_that("prepare_h2_hvarpart_data merges and filters to m2 ages", {
  data_predictors <-
    data.frame(
...
testthat::test_that("prepare_h2_hvarpart_data() returns empty data when a predictor is missing", {
  data_predictors <-
    data.frame(
      region = rep("Europe", 8),
...
testthat::test_that("prepare_h2_hvarpart_data() keeps only ages present in m2 colnames", {
  data_predictors <-
    data.frame(
...
testthat::test_that("prepare_h2_hvarpart_data() validates predictor columns", {
  data_predictors <-
    data.frame(
      region = "Europe",
      climatezone = "Temperate",
