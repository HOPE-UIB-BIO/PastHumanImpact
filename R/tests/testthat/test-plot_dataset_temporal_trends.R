testthat::test_that("plot_dataset_temporal_trends plots raw and fitted data", {
  variable_levels <-
...
testthat::test_that("plot_dataset_temporal_trends requires one matching core", {
  data_observed <-
    tibble::tibble(
      dataset_id = c("d1", "d2"),
      variable = "n0",
...
testthat::test_that("plot_dataset_temporal_trends validates columns", {
  testthat::expect_error(
    plot_dataset_temporal_trends(
