testthat::test_that("prepare_pollen_data() selects requested columns and adds percentages", {
  ...
  result <-
    prepare_pollen_data(data_assembly)
...
testthat::test_that("prepare_pollen_data() keeps required core columns", {
  testthat::skip_if_not_installed("REcopol")
  ...
  result <- prepare_pollen_data(data_assembly)
...
testthat::test_that("prepare_pollen_data() handles empty input", {
  testthat::skip_if_not_installed("REcopol")
...
testthat::test_that("prepare_pollen_data() validates requested variables", {
  testthat::skip_if_not_installed("REcopol")
