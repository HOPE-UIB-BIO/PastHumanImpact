testthat::test_that("resolve_model_seed() is stable and model specific", {
  result_first <-
    resolve_model_seed(
...
testthat::test_that("resolve_model_seed() changes across attempts", {
  result <-
    resolve_model_seed(
...
testthat::test_that("resolve_model_seed() validates inputs", {
