testthat::test_that("diagnose_function_contract_coverage() reports coverage table", {
  root_dir <-
...
testthat::test_that("diagnose_function_contract_coverage() can fail on missing contracts", {
  root_dir <-
...
testthat::test_that("diagnose_function_contract_coverage() excludes testing helpers only", {
  root_dir <-
