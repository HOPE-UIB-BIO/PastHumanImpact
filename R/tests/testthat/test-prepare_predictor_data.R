testthat::test_that("prepare_predictor_data() joins SPD and climate data", {
...
testthat::test_that("prepare_predictor_data() keeps only intersecting dataset_id", {
  data_source_spd_events <-
    data.frame(
      dataset_id = c(1, 2),
      data_merge = I(list(
...
testthat::test_that("prepare_predictor_data() removes rows with NA after merge", {
  data_source_spd_events <-
    data.frame(
      dataset_id = 9,
...
testthat::test_that("prepare_predictor_data() validates required columns", {
  data_source_spd_events <-
    data.frame(
      dataset_id = 1,
