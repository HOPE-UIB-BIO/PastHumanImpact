testthat::test_that(
  "calculate_moran_scale_diagnostic() returns one diagnostic row",
  {
    data_input <-
    ...
    data_result <-
      calculate_moran_scale_diagnostic(
...
testthat::test_that(
  "calculate_moran_scale_diagnostic() validates the value column",
  {
