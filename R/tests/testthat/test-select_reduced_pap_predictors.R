testthat::test_that("select_reduced_pap_predictors() returns a non-empty vector", {
  data_collinearity <-
    list(
...
testthat::test_that("select_reduced_pap_predictors() validates required inputs", {
...
testthat::test_that("select_reduced_pap_predictors() errors on edge-case selections", {
  data_no_eligible <-
    list(
      group_diagnostics = tibble::tibble(
        region = c("A"),
