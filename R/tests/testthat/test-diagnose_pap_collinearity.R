testthat::test_that("diagnose_pap_collinearity() returns expected list structure", {
...
testthat::test_that("diagnose_pap_collinearity() validates required inputs", {
  set.seed(900723)

  testthat::expect_error(
    diagnose_pap_collinearity(data_source = "not_a_data_frame"),
