testthat::test_that("save_dataset_temporal_figure writes and reuses a PNG", {
  path_output_dir <-
...
testthat::test_that("save_dataset_temporal_figure validates dataset IDs", {
