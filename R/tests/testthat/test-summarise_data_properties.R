testthat::test_that("summarise_data_properties() merges nested properties", {
...
testthat::test_that("summarise_data_properties() uses pap_density when used_rescale is FALSE", {
  data_source_diversity <-
    data.frame(
      dataset_id = 5,
...
testthat::test_that("summarise_data_properties() drops rows with NA after merge", {
  data_source_diversity <-
    data.frame(
      dataset_id = 2,
...
testthat::test_that("summarise_data_properties() validates required columns", {
  data_source_diversity <-
    data.frame(
      dataset_id = 1,
...
testthat::test_that("summarise_data_properties() validates used_rescale flag", {
  data_source_diversity <-
    data.frame(
      dataset_id = 1,
