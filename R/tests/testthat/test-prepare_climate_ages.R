testthat::test_that("prepare_climate_ages computes age columns after join", {
...
testthat::test_that("prepare_climate_ages adds missing time_month_value as zero", {
  testthat::skip_if_not_installed("dplyr")
...
testthat::test_that("prepare_climate_ages() validates required columns", {
  data_source <-
    data.frame(
      dataset_id = 1
    )
