testthat::test_that("build_hgam_formula builds a common trend formula", {
  result <-
    build_hgam_formula(
      x_var = "age",
      y_var = "response",
...
testthat::test_that("build_hgam_formula builds a group-specific formula", {
  result <-
    build_hgam_formula(
      x_var = "time",
      y_var = "y",
...
testthat::test_that("build_hgam_formula derives sel_m from common trend", {
  result_true <-
    build_hgam_formula(
      n_groups = 2,
      common_trend = TRUE
...
testthat::test_that("build_hgam_formula validates n_groups", {
  testthat::expect_error(
    build_hgam_formula(n_groups = 0),
    regexp = "n_groups"
  )
})

testthat::test_that("build_hgam_formula builds a stratum fs formula", {
  result <-
    build_hgam_formula(
      x_var = "age_ka",
      y_var = "value",
...
testthat::test_that("build_hgam_formula builds a stratum fs dataset slope formula", {
  result <-
    build_hgam_formula(
      x_var = "age_ka",
      y_var = "value",
...
testthat::test_that("build_hgam_formula builds a stratum fs dataset fs formula", {
  result <-
    build_hgam_formula(
      x_var = "age_ka",
      y_var = "value",
...
testthat::test_that("build_hgam_formula builds within-stratum dataset formulas", {
  result_intercept <-
    build_hgam_formula(
      x_var = "age_ka",
      y_var = "value",
