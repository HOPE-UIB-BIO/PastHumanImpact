testthat::test_that("build_model_config_table() creates one row per variable and stratum", {
  data_model <-
    tibble::tibble(
...
testthat::test_that("build_model_config_table() applies large-model sampling settings", {
  data_model <-
    tibble::tibble(
...
testthat::test_that("build_model_config_table() validates family coverage", {
  data_model <-
    tibble::tibble(
      dataset_id = "d1",
      region = "Europe",
...
testthat::test_that("build_model_config_table() handles response checks", {
  data_model <-
    tibble::tibble(
...
testthat::test_that("build_model_config_table() retains partial variation", {
  data_model <-
    tibble::tibble(
...
testthat::test_that("build_model_config_table() rejects invalid scaling", {
  data_model <-
    tibble::tibble(
      dataset_id = c("d1", "d2"),
      region = "Europe",
