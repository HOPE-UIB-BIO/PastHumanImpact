testthat::test_that("prepare_climatezone_factor() recodes and labels", {
  data_input <-
    data.frame(
      climatezone = c(
        "Polar",
  ...
  res_data <-
    prepare_climatezone_factor(data_input)
...
testthat::test_that("prepare_climatezone_factor() preserves untouched values", {
  data_input <-
    data.frame(
...
testthat::test_that("prepare_climatezone_factor() sets unknown labels to NA", {
  data_input <-
    data.frame(
...
testthat::test_that("prepare_climatezone_factor() errors without climatezone", {
  data_input <-
    data.frame(
  ...
  testthat::expect_error(
    prepare_climatezone_factor(data_source = data_input),
