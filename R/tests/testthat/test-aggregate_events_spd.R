testthat::test_that("aggregate_events_spd() validates required columns", {
  bad_events <-
    data.frame(
      dataset_id = 1,
...
testthat::test_that("aggregate_events_spd() validates dummy age column", {
  data_events <-
    data.frame(
      dataset_id = 1,
