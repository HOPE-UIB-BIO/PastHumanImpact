testthat::test_that("compute_dcca adds dcca_scores and dcca_grad_length, filters datasets with failed ordinations", {
  ...
  result <- compute_dcca(data_pollen)
...
testthat::test_that("compute_dcca() returns expected columns and classes", {
  testthat::skip_if_not_installed("REcopol")
...
testthat::test_that("compute_dcca() handles empty input", {
  testthat::skip_if_not_installed("REcopol")
...
testthat::test_that("compute_dcca() validates required columns", {
  bad_input <-
    tibble::tibble(
      dataset_id = 1L,
