testthat::test_that("prepare_diversity_dcca_model_data() builds weighted nested series", {
  ...
  result <-
    prepare_diversity_dcca_model_data(
...
testthat::test_that("prepare_diversity_dcca_model_data() includes both variables when present", {
  data_source_diversity <-
    data.frame(
      PAP_diversity = I(list(data.frame(
        dataset_id = c(2, 2),
...
testthat::test_that("prepare_diversity_dcca_model_data() drops NA values after pivot", {
  data_source_diversity <-
    data.frame(
      PAP_diversity = I(list(data.frame(
        dataset_id = c(1, 1),
...
testthat::test_that("prepare_diversity_dcca_model_data() validates PAP_diversity input", {
  bad_diversity <-
    data.frame(
      dataset_id = 1,
      stringsAsFactors = FALSE
