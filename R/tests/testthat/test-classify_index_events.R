testthat::test_that("classify_index_events() detects strong and weak evidence", {
  data_source_indices <-
    data.frame(
...
testthat::test_that("classify_index_events() returns expected core columns", {
  data_source_indices <-
    data.frame(
      evidence = "STRONG",
...
testthat::test_that("classify_index_events() applies grain threshold for STRONG", {
  data_source_indices <-
    data.frame(
      evidence = "STRONG",
      taxa_vector = I(list(c("TaxaA"))),
...
testthat::test_that("classify_index_events() validates required columns", {
