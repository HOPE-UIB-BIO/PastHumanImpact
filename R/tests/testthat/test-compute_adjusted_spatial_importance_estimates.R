testthat::test_that(
  "compute_adjusted_spatial_importance_estimates() sets dbMEMs to zero",
  {
    data_input <-
      tibble::tibble(
    ...
    data_result <-
      compute_adjusted_spatial_importance_estimates(
...
testthat::test_that(
  "compute_adjusted_spatial_importance_estimates() validates models",
  {
