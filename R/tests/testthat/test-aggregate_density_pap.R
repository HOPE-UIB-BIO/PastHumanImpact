testthat::test_that("aggregate_density_pap() returns expected list-columns", {
...
testthat::test_that("aggregate_density_pap() respects limit_length age range", {
  testthat::skip_if_not_installed("REcopol")
  testthat::skip_if_not_installed("scales")
...
testthat::test_that("aggregate_density_pap() handles empty change points", {
  testthat::skip_if_not_installed("REcopol")
  testthat::skip_if_not_installed("scales")
...
testthat::test_that("aggregate_density_pap() validates required columns", {
  bad_cp <-
    tibble::tibble(
      dataset_id = 1L
    )
