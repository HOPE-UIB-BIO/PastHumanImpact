testthat::test_that("fit_varhp() returns summary table from injected hvar function", {
  data_source <-
    data.frame(
      roc = c(0.1, 0.2, 0.3),
      spd = c(10, 20, 30),
...
testthat::test_that("fit_varhp() merges significance output when requested", {
  data_source <-
    data.frame(
      roc = c(0.1, 0.2, 0.3),
      spd = c(10, 20, 30),
...
testthat::test_that("fit_varhp() validates required arguments", {
  testthat::expect_error(
    fit_varhp(data_source = "not_a_data_frame"),
