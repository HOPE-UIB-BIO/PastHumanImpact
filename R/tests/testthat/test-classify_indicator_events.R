testthat::test_that("classify_indicator_events() applies Pinus exclusion and thresholds", {
...
testthat::test_that("classify_indicator_events() keeps Pinus as STRONG outside exclusion countries", {
  data_source_indicators <-
    data.frame(
      level_2 = "Pinus",
      evidence = "STRONG",
...
testthat::test_that("classify_indicator_events() returns expected core columns", {
  data_source_indicators <-
    data.frame(
      level_2 = "Weed",
      evidence = "WEAK",
...
testthat::test_that("classify_indicator_events() validates required columns", {
