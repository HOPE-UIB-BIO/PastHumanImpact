testthat::test_that("build_dataset_temporal_caption formats metadata", {
  data_metadata <-
    tibble::tibble(
      long = -70.25,
      lat = 46.4,
  ...
  result <-
    build_dataset_temporal_caption(data_metadata)
...
testthat::test_that("build_dataset_temporal_caption validates metadata", {
  testthat::expect_error(
    build_dataset_temporal_caption(tibble::tibble(long = 8.5)),
