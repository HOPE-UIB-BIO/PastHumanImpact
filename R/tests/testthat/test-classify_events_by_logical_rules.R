testthat::test_that("classify_events_by_logical_rules() applies Europe and Oceania rules", {
  data_source <-
    data.frame(
      dataset_id = c(1, 2),
  ...
  res_data <-
    classify_events_by_logical_rules(data_source)
...
testthat::test_that("classify_events_by_logical_rules() returns North America output contract", {
  data_source <-
    data.frame(
      dataset_id = 9,
...
testthat::test_that("classify_events_by_logical_rules() errors for unsupported regions", {
  data_source <-
    data.frame(
      dataset_id = 1,
      region = "Atlantis",
...
testthat::test_that("classify_events_by_logical_rules() validates required columns", {
  testthat::expect_error(
    classify_events_by_logical_rules(
