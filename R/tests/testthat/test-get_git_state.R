testthat::test_that("get_git_state() reports clean and dirty repositories", {
...
testthat::test_that("get_git_state() returns missing values after Git failure", {
  result <-
    get_git_state(
      repo_path = tempdir(),
...
testthat::test_that("get_git_state() validates the repository path", {
