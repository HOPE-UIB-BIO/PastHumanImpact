testthat::test_that(
  "calculate_moran_diagnostics() detects positive spatial pattern",
  {
    data_input <-
      tibble::tibble(
        dataset_id = 1:10,
...
testthat::test_that(
  "calculate_moran_diagnostics() reports an unlinked distance graph",
  {
    data_input <-
      tibble::tibble(
        dataset_id = 1:3,
...
testthat::test_that(
  "calculate_moran_diagnostics() links co-located distinct records",
  {
    data_input <-
      tibble::tibble(
        dataset_id = 1:3,
