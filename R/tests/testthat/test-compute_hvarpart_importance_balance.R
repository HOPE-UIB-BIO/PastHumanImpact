testthat::test_that(
  "compute_hvarpart_importance_balance() calculates bounded differences",
  {
    data_summary <-
      tibble::tibble(
...
testthat::test_that(
  "compute_hvarpart_importance_balance() rejects incomplete pairs",
  {
    data_summary <-
      tibble::tibble(
...
testthat::test_that(
  "compute_hvarpart_importance_balance() validates unique group keys",
  {
    data_summary <-
      tibble::tibble(
        analysis = "temporal_spd",
