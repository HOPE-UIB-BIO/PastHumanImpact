testthat::test_that("fit_pca() returns a vegan rda object on expected columns", {
...
testthat::test_that("fit_pca() returns rda with scale = FALSE", {
  testthat::skip_if_not_installed("vegan")
...
testthat::test_that("fit_pca() errors when required columns are absent", {
  testthat::skip_if_not_installed("vegan")
...
testthat::test_that("fit_pca() validates scale argument", {
  testthat::expect_error(
    fit_pca(data.frame(), scale = "yes"),
