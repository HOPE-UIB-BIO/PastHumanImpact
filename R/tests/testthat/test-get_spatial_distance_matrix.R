testthat::test_that(
  "get_spatial_distance_matrix() returns great-circle distances in km",
  {
    data_input <-
      tibble::tibble(
        dataset_id = c("a", "b"),
    ...
    mat_result <-
      get_spatial_distance_matrix(data_source = data_input)
...
testthat::test_that(
  "get_spatial_distance_matrix() validates required columns",
  {
