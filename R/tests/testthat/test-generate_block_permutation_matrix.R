testthat::test_that(
  "generate_block_permutation_matrix() preserves every block",
  {
    set.seed(900723)
    vec_values <- 1:7
...
testthat::test_that(
  "generate_block_permutation_matrix() validates lengths",
  {
...
testthat::test_that(
  "generate_block_permutation_matrix() preserves sampling order",
  {
    vec_values <- 1:6
