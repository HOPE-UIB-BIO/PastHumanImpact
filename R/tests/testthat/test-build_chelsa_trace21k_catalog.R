testthat::test_that("build_chelsa_trace21k_catalog generates distinct rows with correct URL structure", {
  # Minimal call: 1 bio variable, 1 time step
  result <- build_chelsa_trace21k_catalog(
    variables  = "bio",
    bio_var    = 1L,
    month_var  = 1L,
    time_var   = 0L
...
testthat::test_that("build_chelsa_trace21k_catalog generates correct count for non-bio variable", {
  result <- build_chelsa_trace21k_catalog(
    variables  = "tasmin",
    bio_var    = 1L,
    month_var  = c(1L, 2L),
...
testthat::test_that("build_chelsa_trace21k_catalog validates variable names", {
  testthat::expect_error(
    build_chelsa_trace21k_catalog(variables = "invalid"),
