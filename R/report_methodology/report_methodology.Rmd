...
Set in summary figures here of the events type in different regions within ecozones: 
```{r}
...
Set in figure of the events indicators in different ecozone
```{r}
...
set in figure summary figure of spds in time for different regions and ecozones:
```{r}
